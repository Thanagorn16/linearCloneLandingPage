				...
				<div className="flex mt-65 h-130 border-y-3 border-[hsla(0,0%,100%,.05)]">
					<div>
						...
						<div className="relative">
							...
							<div className="absolute inset-0  bg-gradient-to-l from-[#090a0b] to-transparent"></div>
							<div className="absolute inset-0  bg-gradient-to-b from-transparent to-[#090a0b]"></div>
						</div>
					</div>
				</div>
			</div>
