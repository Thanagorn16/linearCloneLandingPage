		...
		<section className="w-full bg-gradient-to-b from-[hsl(210,10%,8%)] to-[#090a0b]">
			<div className="max-w-5xl mx-auto px-4">
				...
				<div className="flex mt-65 h-130 border-y-3 border-[hsla(0,0%,100%,.05)]">
					<div>
						<h2 className="pt-15 text-2xl font-medium text-[#f7f8f8]">
						...
						<div className="relative mt-10 w-95 h-70 p-6 rounded-xl bg-[hsla(0,0%,100%,.08)] border border-[hsla(0,0%,100%,.17)]">
							...
							<div className="grid grid-cols-6 w-85 py-5 gap-y-4  items-center">
								...
								<div className="col-start-3 col-end-7">
									<div className="flex items-center gap-1">
										...
										>
											<path d="M10.7519 6.0284L8.25194 4.57006C8.1741 4.52466 8.08705 4.50195 8 4.50195V11.3442C8.08705 11.3442 8.1741 11.3215 8.25194 11.2761L10.7519 9.81781C10.9055 9.7282 11 9.56375 11 9.38592V6.46029C11 6.28245 10.9055 6.118 10.7519 6.0284Z"></path><path d="M8.75581 1.21343C8.28876 0.931461 7.71124 0.93146 7.24419 1.21343L2.74419 3.93024C2.28337 4.20846 2 4.71907 2 5.27123V10.7327C2 11.2848 2.28337 11.7954 2.74419 12.0737L7.24419 14.7905C7.71124 15.0724 8.28876 15.0724 8.75581 14.7905L13.2558 12.0737C13.7166 11.7954 14 11.2848 14 10.7327V5.27123C14 4.71907 13.7166 4.20846 13.2558 3.93024L8.75581 1.21343ZM12.5 5.27123L8 2.55442L3.5 5.27123L3.5 10.7327L8 13.4495L12.5 10.7327L12.5 5.27123Z"></path>
										</svg>
								...
								<div className="col-start-3 col-end-7">
									<div className="flex flex-row items-center gap-1">
										<div className="flex gap-1 p-1 items-center rounded-sm bg-[rgb(35,35,38)]">
						...
						<div className="absolute inset-0  bg-gradient-to-br from-transparent to-[#090a0b]"></div>
						</div>
		...
		<svg 
			...
			aria-hidden="true">
				<path d="M7.3406 2.32C7.68741 1.89333 8.31259 1.89333 8.6594 2.32L12.7903 7.402C13.0699 7.74597 13.0699 8.25403 12.7903 8.598L8.6594 13.68C8.31259 14.1067 7.68741 14.1067 7.3406 13.68L3.2097 8.598C2.9301 8.25403 2.9301 7.74597 3.2097 7.402L7.3406 2.32Z" fill="var(--color-brand-bg)" strokeWidth="2" strokeLinejoin="round"></path>
						...
						// <div className="mt-10 w-80 h-95 p-6 rounded-xl
						// 	[background:linear-gradient(135deg,hsla(0,0%,100%,.08),hsla(0,0%,100%,.02),hsla(0,0%,100%,0)_55%)]">
						// 	<h1 className="text-xl font-semibold text-[#f7f8f8]">Project Overview</h1>
						// 	<div className="grid grid-cols-5 gap-4 py-5">
						// 		<div className="col-span-2 col-start-1">
						// 			<span className="text-base text-[#8a8f98]">Properties</span>
						// 		</div>
						...
						// 					xmlns="http://www.w3.org/2000/svg"
						// 				>
						// 					<path d="M10.7519 6.0284L8.25194 4.57006C8.1741 4.52466 8.08705 4.50195 8 4.50195V11.3442C8.08705 11.3442 8.1741 11.3215 8.25194 11.2761L10.7519 9.81781C10.9055 9.7282 11 9.56375 11 9.38592V6.46029C11 6.28245 10.9055 6.118 10.7519 6.0284Z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M8.75581 1.21343C8.28876 0.931461 7.71124 0.93146 7.24419 1.21343L2.74419 3.93024C2.28337 4.20846 2 4.71907 2 5.27123V10.7327C2 11.2848 2.28337 11.7954 2.74419 12.0737L7.24419 14.7905C7.71124 15.0724 8.28876 15.0724 8.75581 14.7905L13.2558 12.0737C13.7166 11.7954 14 11.2848 14 10.7327V5.27123C14 4.71907 13.7166 4.20846 13.2558 3.93024L8.75581 1.21343ZM12.5 5.27123L8 2.55442L3.5 5.27123L3.5 10.7327L8 13.4495L12.5 10.7327L12.5 5.27123Z"></path>
						// 				</svg>
						// 				<span className="text-base text-[#8a8f98]">In Progress</span>
						// 			</div>
						// 		</div>
						// 	</div>
						// </div>